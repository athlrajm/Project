  ...
  return (
    <div>
      ...
      <Card style={{border: "6px solid white"}} >
        ...
        <Card.Body>
        <button type="button" class="btn btn-outline-secondary" data-mdb-ripple-color="dark">MEN'S WEAR</button>
          {/* <Card.Text>
      ...
      <Card style={{border: "6px solid white"}} >
        ...
        <Card.Body>
        <button type="button" class="btn btn-outline-secondary" data-mdb-ripple-color="dark">WOMEN'S WEAR</button>
          {/* <Card.Text>
      ...
      <Card style={{border: "6px solid white"}} >
        ...
        <Card.Body>
        <button type="button" class="btn btn-outline-secondary" data-mdb-ripple-color="dark">KID'S WEAR</button>
          {/* <Card.Text>
            This card has supporting text below as a natural lead-in to
            additional content.{' '}
          </Card.Text> */}
